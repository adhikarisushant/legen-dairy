...
const Header = () => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-1 fixed top-0 right-0 bg-[#111c43]">
      <div
        ...
        <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10 rounded">
          ...
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#000000f]">
            ...
            <p className="px-2 text-black dark:text-white">
              ...
              hic nemo nisi quaerat unde sint, debitis commodi perferendis
              expedita ratione quos ipsa qui modi veritatis. Minus, quam vitae!
            </p>
          ...
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#000000f]">
            ...
            <p className="px-2 text-black dark:text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit ex
              hic nemo nisi quaerat unde sint, debitis commodi perferendis
              expedita ratione quos ipsa qui modi veritatis. Minus, quam vitae!2
            </p>
            <p className="p-2 text-black dark:text-white text-[14px]">
              5 days ago
            </p>
